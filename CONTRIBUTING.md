...
- Read the current MCP schema and [Abide guide](docs/ABIDE_GUIDE.md); behavior and safety boundaries are compatibility-sensitive.
...
Contributions to Abide-owned Covered Code are expected to be compatible with the repository’s CPAL-1.0 licensing and existing third-party notices. Do not copy code or assets without recording the applicable provenance and license obligations.
